...
public class myS3Util {
	...
	public String fileUpload(String fileName, byte[] fileData, String uploadKind) throws FileNotFoundException {
	    ...
	    return s3.generatePresignedUrl(new GeneratePresignedUrlRequest(bucket_name + "/" + uploadFolderPath, fileName)).toString();
	}
