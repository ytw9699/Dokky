...
<c:choose>
   	  <c:when test="${pageContext.request.serverName == 'localhost'}">
			<link href="/resources/css/common/alarmList.css" rel="stylesheet" type="text/css"/>
	  </c:when>
      <c:otherwise>
    		<link href="/ROOT/resources/css/common/alarmList.css" rel="stylesheet" type="text/css"/>
      </c:otherwise>
</c:choose>
</head>
