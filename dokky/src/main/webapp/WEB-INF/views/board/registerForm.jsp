	...
	<head>
		...
		<c:choose>
		   	  <c:when test="${pageContext.request.serverName == 'localhost'}">
					<link href="/resources/css/board/registerForm.css" rel="stylesheet" type="text/css">
			  </c:when>
		      <c:otherwise>
		    		<link href="/ROOT/resources/css/board/registerForm.css" rel="stylesheet" type="text/css">
		      </c:otherwise>
		</c:choose> 
	</head>
<body> 
