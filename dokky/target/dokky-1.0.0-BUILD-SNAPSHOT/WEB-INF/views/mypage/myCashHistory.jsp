...
<meta charset="UTF-8">
	...
	<c:choose>
	   	  <c:when test="${pageContext.request.serverName == 'localhost'}">
				<link href="/resources/css/mypage/myCashHistory.css" rel="stylesheet" type="text/css"/>
		  </c:when>
	      <c:otherwise>
	    		<link href="/ROOT/resources/css/mypage/myCashHistory.css" rel="stylesheet" type="text/css"/>
	      </c:otherwise>
	</c:choose>
</head>
